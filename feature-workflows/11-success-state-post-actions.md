...
flowchart TD
  ...
  D2{"Node: Decision<br/>Name: Which success action was chosen?<br/>Purpose: Route close, copy, paste, restart, or append behaviors."}
  ...
  A4["Node: Action<br/>Name: Restart from success<br/>Purpose: Optionally undo pasted text, preserve retry context, and start new recording." ]
  A5["Node: Action<br/>Name: Append from success<br/>Purpose: Start a new recording intended to append additional dictated output." ]
