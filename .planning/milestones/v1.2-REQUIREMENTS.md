# Requirements Archive: v1.2 AI Trigger Name

**Archived:** 2026-03-20
**Status:** SHIPPED

REQUIREMENTS.md was deleted after v1.2 completion. Next milestone requirements will be defined fresh via `$gsd-new-milestone`.
